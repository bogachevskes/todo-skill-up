...
# Имя образа контейнера клиентской части приложения
DOCKER_FRONTEND_IMAGE_NAME=todo-skill-up-nuxt
# Имя директории клиентской части приложения в директории frontend
DOCKER_FRONTEND_CLIENT_DIR=nuxtJs_v3
# Версия исходного образа контейнера клиентской части приложения
DOCKER_FRONTEND_NODE_VERSION=23-alpine3.22
...
# Базовый путь клиентской части приложения
NUXT_PUBLIC_BASE_PATH=/
# URL API для клиентской части приложения
NUXT_PUBLIC_API_URL=http://localhost:${NGINX_PORT}/api/v1
