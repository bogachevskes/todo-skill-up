...
## [ [4.6.1](https://github.com/bogachevskes/todo-skill-up/releases/tag/4.6.1) ] - 10.06.2024
...
- Исправлено:
  - Добавлена правка скрипта деплоя приложения

## [ [4.6.0](https://github.com/bogachevskes/todo-skill-up/releases/tag/4.6.0) ] - 23.04.2024

- Реализовано:
  - Доработан скрипт деплоя приложения
- Изменено:
  - Удалено дублирование установки типа запроса в тесте обращения к эндпоинту регистрации
  - Исправлена спецификация эндпоинта API удаления пользователя из доски

## [ [4.5.1](https://github.com/bogachevskes/todo-skill-up/releases/tag/4.5.1) ] - 19.02.2024

- Исправлено:
  - Исправлено отсутствие возможности назначить два одинаковых разрешения для одного пользователя на две разные доски, в которых пользователь добавлен как участник

## [ [4.5.0](https://github.com/bogachevskes/todo-skill-up/releases/tag/4.5.0) ] - 19.02.2024

- Реализовано:
  - В "подвале" добавлено отображение версии приложения 
  - На странице досок пользователя добавлен учет разрешений пользователя доски для совершения действий пользователя с доской
  - Добавлена точка входа для тестирования API
  - Добавлены команды управления процессом тестирования
  - Добавлен интеграционный тест доступности API управления статусами доски для пользователя, добавленного в доску с разрешениями управления статусами доски, удаления статусов доски
  - Добавлен интеграционный тест доступности API управления доской для пользователя, добавленного в доску с разрешениями управления доской, удаления доски
  - Добавлен интеграционный тест доступности API списка разрешений доски для пользователя, не добавленного в доску
  - Добавлен интеграционный тест доступности API управления разрешениями других пользователей доски для пользователя, добавленного в доску
  - Добавлен интеграционный тест доступности API управления другими пользователями доски для пользователя, добавленного в доску
  - Добавлен интеграционный тест доступности API управления задачами доски для пользователя, не добавленного в доску
  - Добавлен интеграционный тест доступности API управления статусами доски для пользователя, не добавленного в доску
  - Добавлен интеграционный тест доступности API управления доской для пользователя, не добавленного в доску
  - Добавлен интеграционный тест доступности API управления для пользователя, добавленного в доску, разрешениями другого пользователя доски
  - Добавлен интеграционный тест доступности API управления пользователями доски для пользователя, не добавленного в доску
  - Добавлен интеграционный тест API аутентификации пользователя
  - Добавлен интеграционный тест API регистрации пользователя
  - Добавлен интеграционный тест API поиска пользователя по e-mail
  - Добавлен интеграционный тест API управления разрешениями пользователя для доски
  - Добавлен интеграционный тест API управления пользователями
  - Добавлен интеграционный тест API управления задачами досок
  - Добавлен интеграционный тест API управления статусами досок
  - Добавлен интеграционный тест API управления досками
  - Добавлен интеграционный тест API разрешений доски
  - Актуализирован файл описания проекта
- Исправлено:
  - Исправлен баг поиска сущности статуса при изменении состояния задачи
  - Внесены корректировки в api по итогам тестирования
- Удалено:
  - Удалена валидация совпадения пароля с подтверждающим паролем на стороне пользователя
